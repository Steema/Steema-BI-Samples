...
uses
  System.Classes, BI.DataItem, BI.Persist, BI.Query, BI.Arrays, BI.Arrays.Strings,
  BI.DataSource, BI.Summary, BI.Expressions, BI.Algorithm,
  BI.CollectionItem, BI.Tools, BI.Expression.Filter, BI.Rank,
  BI.Merge;
