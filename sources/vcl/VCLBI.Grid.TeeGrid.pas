...
uses
  ...
  BI.DataItem, BI.UI, BI.Grid.Plugin,
...
begin
  // Pending:
  // Enable of disable (show / hide) an extra grid column showing the
  // row numbers.


  // Note: DBGrid is capable, because it uses its dataset RecNo value
end;
