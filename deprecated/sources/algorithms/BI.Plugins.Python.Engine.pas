...
{$ENDIF}
{$IFDEF VER330} // Delphi 12.0 Rio / Carnival
  {$DEFINE DELPHIX}
  {$DEFINE DELPHI4_OR_HIGHER}
  {$DEFINE DELPHI5_OR_HIGHER}
  {$DEFINE DELPHI6_OR_HIGHER}
  ...
  {$DEFINE DELPHIX01_OR_HIGHER}
  {$DEFINE DELPHIXI0_OR_HIGHER}
  {$DEFINE DELPHIX20_OR_HIGHER}
{$ENDIF}
{$IFDEF VER340} // Delphi 10.4 Denali
  {$DEFINE DELPHIX}
  {$DEFINE DELPHI4_OR_HIGHER}
  {$DEFINE DELPHI5_OR_HIGHER}
  {$DEFINE DELPHI6_OR_HIGHER}
...
{$IFDEF VER350} // Delphi 11.0 Alexandria
  ...
  {$DEFINE DELPHIX20_OR_HIGHER}
  {$DEFINE DELPHIX30_OR_HIGHER}
  {$DEFINE DELPHIX40_OR_HIGHER}
{$ENDIF}
{$IFDEF VER360} // Delphi 12.0 Yukon
  {$DEFINE DELPHIX}
  {$DEFINE DELPHI4_OR_HIGHER}
  {$DEFINE DELPHI5_OR_HIGHER}
  {$DEFINE DELPHI6_OR_HIGHER}
...
var
  E : EDllImportError;
begin
  Result := GetProcAddress( FDLLHandle, {$IFNDEF MSWINDOWS}PChar(String(funcname)){$ELSE}PAnsiChar(funcname){$ENDIF} );
...
begin
  if UseLastKnownVersion then
    ...
    // davidberneda changed to search dynamic "latest" version:
    ...
    begin
      ...
      tmpFile:=GetDllPath+PYTHON_KNOWN_VERSIONS[i].DllName;

      if FileExists(tmpFile) then
      begin
        FDLLHandle := SafeLoadLibrary(tmpFile);
    ...
    raise EDLLLoadError.Create('Error: Cannot find any Python dll '+CPUBits+'installed');
