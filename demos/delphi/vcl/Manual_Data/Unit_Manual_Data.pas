...
// This helper method displays two tables in two grid, linked as a
...
// Mnual data should also be manually destroyed
...
// The only requerimen is detail rows must be ordered on their "master" row,
...
begin
  ...
  TDataAccess(ADetail).IMaster.AppendIndex(5);
  TDataAccess(ADetail).IMaster.AppendIndex(12);
  TDataAccess(ADetail).IMaster.AppendIndex(13);
